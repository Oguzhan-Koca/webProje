...
namespace WebProje.Controllers
{
    public class Hakkimizda : Controller
    {
        ...
        [HttpPost]
        //public IActionResult Guncelle(Hakkimizda hakkimizda)
        //{
        //    HttpClient httpClient = new HttpClient();
        //    StringContent content = new StringContent(JsonConvert.SerializeObject(hakkimizda), Encoding.UTF8,
        //        "application/json");
        //    var responseMessage = httpClient.PutAsync($"https://localhost:44308/api/Hakkimizda/{hakkimizda.HakkimizdaId}", content).Result;
        //    return RedirectToAction("Index");
